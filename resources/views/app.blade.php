...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{url('/')}}" class="logo">
      ...
      <span class="logo-mini"><b>CK</b>Q</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Cake</b>Ku</span>
    </a>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
         ...
         <li class="active treeview">
          <a href="{{ url('admin/pesanan/datakue') }}">
            <i class="fa fa-list"></i> <span>Data Kue</span></a>
